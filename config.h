...
#define PACKAGE_DOC_DIR "/usr/local/doc/acikisletme"
...
#define PACKAGE_SOURCE_DIR "/root/Desktop/acikisletme-2.1"
#define GETTEXT_PACKAGE "acikisletme"
